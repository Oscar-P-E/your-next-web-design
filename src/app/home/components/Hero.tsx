...
export default function Hero() {
  ...
  return (
    <>
      <div className="relative h-[calc(85svh-var(--header-height))] w-full overflow-hidden">
        <div
        ...
        <a
          href="#"
          className="absolute bottom-20 left-1/2 z-10 mx-auto -translate-x-1/2 overflow-hidden rounded-full border-2 border-white bg-oj-500 px-8 py-3 text-xl font-semibold text-white shadow-lg transition-all duration-300 ease-in-out hover:scale-105  hover:bg-oj-400 hover:shadow-xl"
        >
          Get Started
        </a>
      </div>
