...
export default function Hero() {
  ...
  return (
    <>
      <div className="relative h-[calc(95svh-var(--header-height))] w-full overflow-hidden tracking-tighter">
        <div
          className="absolute z-10 grid h-[calc(95svh-var(--header-height))] w-[80%] place-items-center overflow-hidden bg-slate-800 md:w-[69.2%]"
          ref={leftRef}
        >
        ...
        <div className="absolute right-0 grid h-[calc(95svh-var(--header-height))] place-items-center overflow-hidden bg-oj-500">
        ...
        <a
          href="#contact"
          className="text-normal absolute bottom-40 left-1/2 z-10 mx-auto -translate-x-1/2 overflow-hidden rounded-full border-2 border-white bg-oj-500 px-5 py-2.5 font-medium capitalize tracking-normal text-white transition-all duration-300  ease-in-out hover:bg-oj-400 md:bottom-20 md:text-xl"
        >
          Get a quote
        </a>
      </div>
